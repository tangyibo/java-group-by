...
public class PerformanceTest {
	...
	public void testGroupByServiceWithFooAvg100w() throws NumberFormatException, IOException {
		...
		watch.stop();
		long loadTime = watch.getTime();
		System.out.println("Load Data to Memory Time Elapsed(ms) : " + loadTime);
		...
		List<Map<String, String>> r = service.groupBy(new AvgAggregation<Integer>("a", new StringToIntegerConverter()),
				new NoAggregation<Integer>("b", new StringToIntegerConverter()));
		System.out.println("Result table: ");
		r.stream().forEach((i) -> System.out.println(i));
		watch.stop();
		System.out.println(
				"Test Execute Big Data 100w Avg() Group by Time Elapsed(ms) : " + (watch.getTime() + loadTime));
	}
	...
	public void testGroupByServiceWithFooAvg500w() throws NumberFormatException, IOException {
		...
		watch.stop();
		System.out.println(
				"Test Execute Big Data 500w Avg() Group by Time Elapsed(ms) : " + (watch.getTime() + loadTime));
	}
	...
	public void testGroupByServiceWithFooAvg600w() throws NumberFormatException, IOException {
		...
		watch.stop();
		System.out.println(
				"Test Execute Big Data 600w Avg() Group by Time Elapsed(ms) : " + (watch.getTime() + loadTime));
	}
	...
	public void testGroupByServiceWithFooAvg700w() throws NumberFormatException, IOException {
		...
		watch.stop();
		System.out.println(
				"Test Execute Big Data 700w Avg() Group by Time Elapsed(ms) : " + (watch.getTime() + loadTime));
	}
	...
	public void testGroupByServiceWithFooAvg800w() throws NumberFormatException, IOException {
		...
		watch.stop();
		System.out.println(
				"Test Execute Big Data 800w Avg() Group by Time Elapsed(ms) : " + (watch.getTime() + loadTime));
	}
	...
	public void testGroupByServiceWithFooAvg1000w() throws NumberFormatException, IOException {
		...
		watch.stop();
		System.out.println(
				"Test Execute Big Data 1000w Avg() Group by Time Elapsed(ms) : " + (watch.getTime() + loadTime));
	}
	...
	public void testGroupByServiceWithFooAvg2000w() throws NumberFormatException, IOException {
		...
		watch.stop();
		System.out.println(
				"Test Execute Big Data 2000w Avg() Group by Time Elapsed(ms) : " + (watch.getTime() + loadTime));
	}
}
